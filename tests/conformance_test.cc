...
INSTANTIATE_TEST_CASE_P(
  TestParams, ConformanceTest, testing::Values(
    ...
    ConformanceTestData(
      ...
      false,
      kConformanceMoonlight128aac),
    ConformanceTestData(
      "testdata/conformance_testdata_subset/harpsichord48_stereo.wav",
      "testdata/conformance_testdata_subset/harpsichord48_stereo_96kbps_mp3."
          "wav",
      false,
      kConformanceHarpsichord96mp3),
    ConformanceTestData(
